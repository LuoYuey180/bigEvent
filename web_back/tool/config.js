...
// 文章功能的接口：
var ARTICE_GET = baseUrl + '/admin/category_search';
var ARTICE_ADD = baseUrl + '/admin/category_add';
var ARTICE_EDIT = baseUrl + '/admin/category_edit';
var ARTICE_DEL = baseUrl + '/admin/category_delete';